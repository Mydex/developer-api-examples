 ...
 * and accept the Data Sharing Agreement, forming a connection
 * between their PDS and your Subscriber Dedicated Connection.
 */
function createFtc() {
    ...
    echo "Please visit " . json_decode($ftc_request) . "\n";
}
