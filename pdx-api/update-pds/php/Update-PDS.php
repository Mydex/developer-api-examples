...
/**
 * Update several fields for a row in the ds_referrals
 * dataset for this PDS.
 */
function updatePds() {
    ...
    $pds_request_url = MYDEX_PDS_PATH . "/api/pds/transaction/" . MEMBER_UID . ".json?" . $arguments_transactional;
    $ch = curl_init();
